---
title: Gigahex platform
author: David G. Simmons
description:
  Use a Jupyter notebook to create a database, insert and query data and graph
  the results using Python.
image: https://images.unsplash.com/photo-1542744173-8e7e53415bb0?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80
---
