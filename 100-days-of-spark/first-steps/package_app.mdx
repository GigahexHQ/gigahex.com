...
**Wo wo wo ! Now what is workers, executors and driver ? **
...
for evaluating the code. This is ideal for quick testing with small dataset.
...
`CTRL+SHIFT+P` in Windows and `⌘P` on Mac to select the interpreter located in
venv.
